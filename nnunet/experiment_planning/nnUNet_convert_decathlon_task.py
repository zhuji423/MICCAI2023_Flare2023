...
from file_endings import remove_trailing_slash
...
def main():
    ...
    parser = argparse.ArgumentParser(description="The MSD provides data as 4D Niftis with the modality being the first"
                                                 ...
                                                 "expects")
    parser.add_argument("-i", default='E:/1pao/Infer-MedSeg-With-Low-Resource-main/Task07_CoarseFinetune',help="Input folder. Must point to a TaskXX_TASKNAME folder as downloaded from the MSD "
